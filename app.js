...
function renderMap(lat, lon){
  ...
  const map=L.map('leafletMap',{zoomControl:true,attributionControl:true,scrollWheelZoom:false}).setView([lat,lon],5);
  ...
  const icon=L.divIcon({
    className:'',
    html:`<div style="width:14px;height:14px;background:#e8000f;border:2px solid rgba(232,0,15,0.5);border-radius:50%;box-shadow:0 0 14px rgba(232,0,15,0.9);"></div>`,
